            ...
            <div className={styles.home_section_header}>
                ...
                <div className={styles.food_Container}>
                    <div className={styles.food_1}>
                        ...
                        <Image src="/images/chicken.png" width="350" height="350" priority />

                    </div>
                    <div className={styles.food_2}>
                        <Image src="/images/friedChicken.png" width="300" height="300" priority />
                        <Image src="/images/rice.png" width="375" height="300" priority />
                    </div>
